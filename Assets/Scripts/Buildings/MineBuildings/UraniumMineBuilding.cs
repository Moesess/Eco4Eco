...
namespace EcoGame
{
    ...
    namespace Buildings
    {
        public class UraniumMineBuilding : _BaseBuilding
        {
            public UraniumMineBuilding()
            {
                this.Name = "Kopalnia uranu";
            ...
            {
                ResourceManager.Instance.Resources[ResourcesConsts.RESOURCE_URANIUM].Add(this.Production);
            }
        }
    }
}