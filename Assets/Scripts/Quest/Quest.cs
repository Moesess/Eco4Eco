    ...
    public class Quest 
    {
        ...
        public virtual void Initialize() // inizjalizacja
        {
            ...
            if (Random.Range(0, 2) == 0)
            {
                ...
                data.description = "Zdobądź " + data.requiredAmount + " " + ResourceManager.Instance.Resources[data.targetKey].Name.ToLower();
        ...
        private int calculateRequiredAmount(int currentAmount)
        {
            ...
            return currentAmount + Random.Range(2, 5);
        }
        ...
        public void CheckComplete()
        {
            if (getCurrentAmount() >= data.requiredAmount)
            {
                ...
                ResourceManager.Instance.Resources[(int)Resources.RESOURCES.R_POLLUTION].Amount -= Random.Range(100, 400);
                ...
                //popUpWindow.transform.Find("Text Group/Descritpion").GetComponent<TMP_Text>().text = "Wykona�e� zadanie! Zadowolenie spo�eczne ro�nie.";
